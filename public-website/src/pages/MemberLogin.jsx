            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <button
                  ...
                  style={{ border: "1px solid rgba(27, 57, 49, 0.2)", background: "white" }}
                  className="w-full hover:bg-stone-50 active:scale-95 rounded-xl py-4 text-xs font-bold transition flex items-center justify-center gap-2"
                >
