...
const STATIC_PAGES = [
  ...
  { key: "products", name: "Physical Products Catalog (/products)", url: "/products" },
  { key: "digital", name: "Digital Products Market (/digital)", url: "/digital" },
  { key: "blog", name: "Blog / Journal (/blog)", url: "/blog" },
  ...
  { key: "catalog", name: "Product Catalog Index (/catalog)", url: "/catalog" },
  { key: "category-catalog", name: "Category Catalog (/category-catalog)", url: "/category-catalog" },
  { key: "cart", name: "Shopping Cart (/cart)", url: "/cart" },
  { key: "checkout", name: "Secure Checkout (/checkout)", url: "/checkout" },
  { key: "order-success", name: "Order Confirmation (/order-success)", url: "/order-success" },
  { key: "wishlist", name: "Saved Wishlist (/wishlist)", url: "/wishlist font-bold" },
  { key: "track-order", name: "Track Order (/track-order)", url: "/track-order" },
  { key: "login", name: "Member Login / Register (/login)", url: "/login" },
  { key: "profile", name: "User Account Profile (/profile)", url: "/profile" },
  { key: "about", name: "About Us (/about)", url: "/about" },
  { key: "contact", name: "Contact Desk (/contact)", url: "/contact" },
